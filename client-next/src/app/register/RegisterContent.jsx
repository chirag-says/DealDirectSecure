...
import { User, Mail, Lock, Eye, EyeOff, Loader2, CheckCircle, ShieldCheck, RefreshCw, Home, Search, Phone, ArrowLeft, KeyRound, Gift } from "lucide-react";
...
export default function Register() {
  const [formData, setFormData] = useState({ name: "", email: "", password: "", phone: "", agree: false, referralCode: "" });
  ...
  useEffect(() => {
    ...
    if (refCode) {
      setFormData((f) => ({ ...f, referralCode: refCode.toUpperCase().trim() }));
    }
  }, [searchParams]);
          ...
          <form onSubmit={handleMfaVerify} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                onInput={(e) => setMfaCode((e.target.value || "").replace(/[^0-9]/g, '').slice(0, 6))}
                placeholder="000000"
                required
                autoFocus
            ...
            {step === 1 ? (
              <>
                ...
                <div className="mb-6">
                  ...
                  {userType === "owner" && (
                    <p className="text-xs text-amber-600 mt-2 flex items-center gap-1">
                      ...
                      Phone verification required to list properties
                    </p>
                  )}
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-5">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-700 block">Referral Code <span className="text-slate-400 font-normal">(optional)</span></label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      ...
                      <input
                        type="text"
                        name="referralCode"
                        placeholder="e.g. DDAB12"
                        value={formData.referralCode}
                        onChange={handleChange}
                        maxLength={6}
                        className="w-full pl-10 pr-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-900 focus:border-blue-900 transition-colors outline-none text-slate-800 uppercase tracking-wider"
                      />
                    </div>
                    {formData.referralCode && (
                      <p className="text-xs text-green-600 flex items-center gap-1">
                        <CheckCircle className="w-3.5 h-3.5" />
                        Referral code applied — you and your friend will both earn bonus points!
                      </p>
                    )}
                  </div>
              ...
              <>
                ...
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-3xl font-bold text-slate-800">Verify Phone</h2>
                  <p className="text-slate-500 mt-2">
                    We've sent a verification code to <br /> <span className="font-semibold text-slate-800">{formData.phone}</span>
                  </p>
                </div>
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onInput={(e) => setOtp((e.target.value || "").replace(/[^0-9]/g, '').slice(0, 6))}
                      placeholder="123456"
                      autoComplete="one-time-code"
                      inputMode="numeric"
                      required
