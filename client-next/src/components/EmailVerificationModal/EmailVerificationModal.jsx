...
import { X, Smartphone, ShieldCheck, Loader2, RefreshCw, CheckCircle, Home } from "lucide-react";
...
export default function EmailVerificationModal({ isOpen, onClose, user, onVerified }) {
  ...
  const handleSendOtp = async () => {
    setIsLoading(true);
    try {
      await api.post('/users/send-upgrade-otp', {});
  ...
  const handleVerifyOtp = async () => {
    ...
    setIsLoading(true);
    try {
      const res = await api.post('/users/verify-upgrade-otp', { otp });

      // Update user in AuthContext (handles localStorage and cookie refresh)
      const { user: updatedUser } = res.data;
      updateUser(updatedUser);

      toast.success("Phone number verified! You can now list properties.");
              ...
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-5 text-white relative">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">Verify phone number to become a property owner</p>
                  </div>
                </div>
              </div>
                  ...
                  <>
                    ...
                    <div className="text-center mb-6">
                      ...
                      <p className="text-gray-500 text-sm">
                        To list properties, we need to verify your phone number for security.
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 mb-6">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">Registered phone number</p>
                        </div>
                      </div>
                    </div>
