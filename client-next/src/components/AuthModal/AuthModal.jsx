...
import { User, Mail, Lock, Eye, EyeOff, Loader2, CheckCircle, ShieldCheck, Phone } from "lucide-react";
...
const AuthModal = ({ isOpen, onClose }) => {
    ...
    const { login, updateUser, checkAuth } = useAuth();
    ...
    const handleRegisterStep1 = async (e) => {
        ...
        setIsLoading(true);
        try {
            // Defensive re-clean for Safari macOS autofill
    ...
    const handleVerifyOtp = async (e) => {
        ...
        try {
            ...
            // The server sets HttpOnly cookie, store user data for UI
            const { user } = res.data;
            updateUser(user);

            // Re-validate session from server to ensure cookie is established
            await checkAuth();
                            ...
                            <>
                                <div className="text-center mb-8">
                                    ...
                                    <p className="text-slate-500 mt-2">
                                        We've sent a verification code to <br /> <span className="font-semibold text-slate-800">{formData.phone}</span> to activate your seller account.
                                    </p>
                                </div>
